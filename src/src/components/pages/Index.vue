        ...
        <div class="index_tool_item"
          ...
          <div class="index_tool_item_body">
            <div class="index_tool_item_card"
                 ...
                 @click="goTo">
              <div class="index_tool_item_tag_container"
                   v-if="card.hot || (new Date().getTime() - Number(card.createTime) < tagNewTs)">
                <img :src="assets.tag.hot"
                     alt="hot"
                     v-if="card.hot">
                <img :src="assets.tag.new"
                     alt="new"
                     v-else-if="new Date().getTime() - Number(card.createTime) < tagNewTs">
              </div>
