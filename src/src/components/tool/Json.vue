  ...
  <div class="tool_container"
    ...
    <Split v-model="split"
      ...
      <div slot="left"
        ...
        <Input v-model="jsonStr"
               type="textarea"
               autofocus
               class="unformat_wrapper"
      ...
      <div slot="right"
        ...
        <div class="json_target"
             id="json-dest"
             v-html="formatJsonStr">
        </div>
        <div class="operation_container">
          <div class="operation_item copy-format-json"
               data-clipboard-target="#json-dest">
            <Tooltip content="复制"
                     placement="bottom">
              <Icon type="md-copy"
                    size="20" />
  ...
  methods: {
    getQueryStr () {
      if (this.$route.query.q) {
        this.jsonStr = decodeURIComponent(this.$route.query.q.trim())
      }
    }
  },
  created () {
