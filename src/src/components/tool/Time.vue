  ...
  <div class="tool_container"
    ...
    <div class="tool_inner">
      <div class="line">
        <div class="content">
          <span>当前时间戳（ms）: </span>
          <input class="inline_input colorImportant"
                 :readonly="true"
                 type="text"
                 :value="currentTs" />
        </div>
      ...
      <div class="line line2">
        <div class="content content2">
          <span>北京时间: </span>
          <input class="inline_input w50"
                 type="text"
                 v-model="userDate2[0]" /><span class="date_label">年</span>
          <input class="inline_input w50"
                 type="text"
                 v-model="userDate2[1]" /><span class="date_label">月</span>
          <input class="inline_input w50"
                 type="text"
                 v-model="userDate2[2]" /><span class="date_label">日</span>
          <input class="inline_input w50"
                 type="text"
                 v-model="userDate2[3]" /><span class="date_label">时</span>
          <input class="inline_input w50"
                 type="text"
                 v-model="userDate2[4]" /><span class="date_label">分</span>
          <input class="inline_input w50"
                 type="text"
                 v-model="userDate2[5]" /><span class="date_label">秒</span>
