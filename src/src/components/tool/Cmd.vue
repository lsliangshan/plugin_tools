<template>
  <div class="window_cmd_container"
       :style="windowCmdContainerStyles">
    <div class="window_cmd_inner"
         :class="{show: shown}"
         :style="{pointerEvents: (shown ? 'auto' : 'none')}">
      <div class="window_cmd_toggle_container">
        <Tooltip :content="shown ? '关闭操作框 cmd/ctrl + shift + R' : '打开操作框 cmd/ctrl + shift + R'"
                 placement="left">
          <div class="window_cmd_toggle"
               @click="toggleCmdContainer">
            <Icon type="md-hammer"
                  size="20" />
          </div>
        </Tooltip>
      ...
      <div class="window_cmd_content">
        <div class="window_cmd_console">
          <div class="window_cmd_console_item"
               v-for="(item, index) in historyConsoles"
               :key="index"
               :class="item.type">
            <div class="window_cmd_console_item_inner"
