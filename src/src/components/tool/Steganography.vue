      ...
      <Form :label-width="80">
        <FormItem>
          <div slot="label"
            ...
            <Tooltip content="请设置查看密码，不填则不设置密码"
                     placement="top"
          ...
          <Input type="password"
                 placeholder="请输入查看密码"
                 v-model="encodeModal.password" />
        </FormItem>
        <FormItem label="加密内容">
          <Input v-model="encodeModal.message"
                 type="textarea"
                 :autosize="{minRows: 2,maxRows: 5}"
                 placeholder="请输入加密的内容" />
        </FormItem>
      </Form>
    </Modal>
